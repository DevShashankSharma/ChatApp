                    ...
                    <div className="flex flex-col items-center gap-4">
                        <div className="relative">
                            ...
                            <label
                                ...
                                className={`absolute bottom-0 right-0 cursor-pointer bg-base-content p-2 rounded-full transition-all duration-200" ${isUpdatingProfile ? "animate-pulse pointer-events-none" : ""}`}
                            >
